...
(function () {
  ...
  const GENERATED_AT = "2026-08-25T10:09:26.010Z";
  const EXPIRES_AT = "2026-08-25T12:09:26.010Z";
  const EXPIRES_AT_MS = Date.parse(EXPIRES_AT);
  const PATH_SEGMENT = "zx-free-ask-static-57fa93bdfce8fb2e59a4c198eae0f797";
